...
public class VentanaDetallesResultados {
    ...
    public VentanaDetallesResultados(Orden orden) {
        ...
        // Header con datos del paciente/orden
        ...
        info.add(new JLabel(orden.getEmpresa() != null ? orden.getEmpresa() : ""));
        ...
        // Izquierda: Lista de exámenes solicitados
        ...
        listaExamenes.addListSelectionListener(e -> {
            ...
            if (n.contains("hematologia completa") || n.contains("hematologia")) {
                ...
                // Crear panel simple para otros exámenes si no existe
                String cardName = "simple_" + sel;
                if (!cardExists(cardName)) {
                    panelDerecho.add(crearPanelSimple(sel), cardName);
                }
                cards.show(panelDerecho, cardName);
            }
        });
